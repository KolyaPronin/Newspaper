...
const transformLayout = (layout: LayoutFromAPI): Layout => ({
  ...
  reviewComment: layout.reviewComment ?? null,
...
export const layoutAPI = {
  getLayouts: async (params?: { templateId?: string; issueId?: string; pageNumber?: number; limit?: number; status?: string }): Promise<Layout[]> => {
