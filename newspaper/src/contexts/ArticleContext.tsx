...
interface ArticleContextType {
  ...
  requestRevision: (articleId: string, revisionNote: string) => Promise<void>;
...
export const ArticleProvider: React.FC<ArticleProviderProps> = ({ children }) => {
  ...
  const requestRevision = async (articleId: string, revisionNote: string): Promise<void> => {
    setLoading(true);
    setError(null);
    try {
      const apiArticle = await articleAPI.requestRevision(articleId, revisionNote);
      const article = transformArticle(apiArticle);
